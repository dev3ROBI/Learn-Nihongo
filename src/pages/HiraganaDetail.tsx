...
export default function HiraganaDetail() {
  ...
  if (!item) {
    return (
      <div className="text-center py-12">
        ...
        <Link to="/hiragana" className="text-primary block mt-4 hover:underline">
          <i className="fa-solid fa-arrow-left mr-1" />হিরাগানা লিস্টে ফিরুন
        </Link>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-lg mx-auto text-center">
      <Link to="/hiragana" className="text-primary hover:underline inline-flex items-center mb-6 text-sm gap-1">
        <i className="fa-solid fa-arrow-left" /> হিরাগানা লিস্ট
      </Link>
